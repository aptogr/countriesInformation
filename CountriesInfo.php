...
class CountriesInfo {
	...
	/**
	 * List of all the countries indexed by the ISO Countries Code
	 * https://en.wikipedia.org/wiki/ISO_3166-1
	 */
	const COUNTRIES  = array(
        "AFG" => array("country" => "Afghanistan", "continent" => "Asia"),
        ...
        "ASM" => array("country" => "American Samoa", "continent" => "Oceania"),
        ...
        "NAM" => array("country" => "Namibia", "continent" => "Africa"),
        ...
        "SAU" => array("country" => "Saudi Arabia", "continent" => "Asia"),
	...
	/**
	 * List of all the continents index by the ISO Continent Code
	 * https://en.wikipedia.org/wiki/ISO_3166-1
	 */
	 ...
	 * If a country name cannot be found then the country code is returned
	 *
	...
	public function getCountryName( $countryCode ){
		...
		return ( isset( $countries[ $countryCode ] ) ? $countries[ $countryCode ]['country'] : $countryCode );
	...
	/**
	 * Returns the continent name based on the country code
	 * If a continent name cannot be found then the country code is returned
	 *
	 * @param $countryCode string
	 * @return string
	 */
	public function getCountryContinent( $countryCode ){
		...
		$countries = $this->getCountries();
		return ( isset( $countries[ $countryCode ] ) ? $countries[ $countryCode ]['continent'] : $countryCode );
	...
	/**
	 * Returns the continent name based on the continent code
	 * If a continent name cannot be found then the continent code is returned
	 *
	...
	public function getContinentName( $continentCode ){
		...
		return ( isset( $continents[ $continentCode ] ) ? $continents[ $continentCode ] : $continentCode );
	...
	public function isCountry( $countryCode ){
		...
		$countries = $this->getCountries();
		return ( isset( $countries[ $countryCode ] ) ? true : false );
	...
	/**
	 * Checks if a code is a continent
	 * Returns true or false
	 *
	 * @param $continentCode string
	 * @return string
	 */
	public function isContinent( $continentCode ){

		$continents = $this->getContinents();
		return ( isset( $continents[ $continentCode ] ) ? true : false );

	}


	public function getContinentCountries(){

		$countries_per_continent = array();
		$countries = $this->getCountries();

		foreach( $countries as $code => $country ){

			$countries_per_continent[ $country['continent'] ][] = $code;

		}

		return $countries_per_continent;

	}



	public function getCountriesContinent( $continentCode ){

		$continentName              = $this->getContinentName( $continentCode );
		$countries_per_continent    = $this->getContinentCountries();

		return ( isset( $countries_per_continent[ $continentName ] ) ? $countries_per_continent[ $continentName ] : false );
